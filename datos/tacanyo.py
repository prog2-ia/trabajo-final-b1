...
class Tacanyo(Vendedor):  # Subclase de vendedor, este es mas dificil que te lo venda
    ...
    def negociar(self, precio_original: float, #Forma de negociar de un tacanyo.
        ...
        # P04: Variable local puesta como float
